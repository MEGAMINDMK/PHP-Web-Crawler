...
$anchors = $dom -> getElementsByTagName('img');     
 ...
 echo '<img src="'.$src.'" alt="'.$alt.'" style="width: 300px; height: 168px; margin-top: 6px; -moz-box-shadow: 0 0 10px #ccc; -webkit-box-shadow: 0 0 10px #ccc; box-shadow: 0 0 10px #ccc;">&nbsp;';      
 }
 }
 ?> 
